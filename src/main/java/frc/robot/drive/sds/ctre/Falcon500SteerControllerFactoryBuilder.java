package frc.robot.drive.sds.ctre;

import static frc.robot.drive.sds.ctre.CtreUtils.checkCtreError;

import com.ctre.phoenix.motorcontrol.*;
import com.ctre.phoenix.motorcontrol.can.TalonFX;
import com.ctre.phoenix.motorcontrol.can.TalonFXConfiguration;
import edu.wpi.first.wpilibj.shuffleboard.ShuffleboardContainer;
import frc.robot.drive.sds.AbsoluteEncoder;
import frc.robot.drive.sds.AbsoluteEncoderFactory;
import frc.robot.drive.sds.ModuleConfiguration;
import frc.robot.drive.sds.SteerController;
import frc.robot.drive.sds.SteerControllerFactory;
