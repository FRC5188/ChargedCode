...
public class CmdMoveClawToSetpoint extends CommandBase {

  private Arm _armSubsystem;
  private ArmPosition _setpoint;

  /** Creates a new CmdArmRunElbowPID. */
  public CmdMoveClawToSetpoint(Arm armSubsystem, ArmPosition setpoint) {
  ...
  @Override
  public void execute() {
    this._armSubsystem.elbowMotorPIDExec();
