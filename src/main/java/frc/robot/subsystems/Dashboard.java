...
public class Dashboard extends SubsystemBase {
	...
	public Dashboard(Arm armSubsystem, Drive driveSubsystem, Vision visionSubsystem) {
		...
		dashboard.add("Gyro", driveSubsystem.getGyroInstance())
				.withPosition(8, 0)
				.withSize(2, 4)
		...
		_hasGamepieceEntry = arm.add("Has Gamepiece", _hasGamepiece).withWidget(BuiltInWidgets.kBooleanBox)
				.withProperties(Map.of("Color when true", "Lime", "Color when false", "Red")).getEntry();
